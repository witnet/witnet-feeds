...
module.exports = {
    ...
    WitOracleRequestPriceCryptoGlintUsdc6: templates.WitOracleRequestTemplateBeamswapTicker6
        .buildRadonRequest(
    ...
    WitOracleRequestPriceCryptoImmoMcusd6: templates.WitOracleRequestTemplateUbeswapTicker6
        .buildRadonRequest(
