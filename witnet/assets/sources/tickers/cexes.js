...
module.exports = {
    "aex.zone/ticker": Witnet.Sources.HttpGet({
    ...
    "ascendex.com/ticker": Witnet.Sources.HttpGet({
    ...
    "bkex.com/ticker": Witnet.Sources.HttpGet({
    ...
    "binance.com/ticker": Witnet.Sources.HttpGet({
    ...
    "bitvavo.com/ticker": Witnet.Sources.HttpGet({
    ...
    "coinone.co.kr/ticker": Witnet.Sources.HttpGet({
    ...
    "coinyep.com/ticker#9": Witnet.Sources.HttpGet({
    ...
    "digifinex.com/ticker": Witnet.Sources.HttpGet({
    ...
    "freeforexapi.com/ticker#9": Witnet.Sources.HttpGet({
    ...
    "gateapi.io/ticker": Witnet.Sources.HttpGet({
        url: "https://data.gateapi.io/api2/1/ticker/\\0\\_\\1\\",
        script: Witnet.Script().parseJSONMap().getFloat("last").multiply(1e6).round(),
    }),
    "gateapi.io/ticker#9": Witnet.Sources.HttpGet({
        url: "https://data.gateapi.io/api2/1/ticker/\\0\\_\\1\\",
        script: Witnet.Script().parseJSONMap().getFloat("last").multiply(1e9).round(),
    }),
    "exchangerate.host/ticker#9": Witnet.Sources.HttpGet({
    ...
    "fastforex.io/ticker#9": Witnet.Sources.HttpGet({
    ...
    "gemini.com/ticker": Witnet.Sources.HttpGet({
        url: "https://api.gemini.com/v1/pubticker/\\0\\\\1\\",
        script: Witnet.Script().parseJSONMap().getFloat("last").multiply(1e6).round(),
        tuples: { "USDC/USD-6": [ "usdc", "usd" ] },
    }),
    "hitbtc.com/ticker": Witnet.Sources.HttpGet({
    ...
    "hotbit.io/ticker": Witnet.Sources.HttpGet({
    ...
    "huobi.pro/ticker": Witnet.Sources.HttpGet({
    ...
    "huobi.pro/ticker#9": Witnet.Sources.HttpGet({
        url: "https://api.huobi.pro/market/detail/merged?symbol=\\0\\\\1\\",
        script: Witnet.Script().parseJSONMap().getMap("tick").getFloat("close").multiply(1e6).round(),
        tuples: {
            "BNB/USDT-9": [ "bnb", "usdt" ],
    ...
    "indoex.io/ticker": Witnet.Sources.HttpGet({
    ...
    "jsdelivr.net/ticker#9": Witnet.Sources.HttpGet({
    ...
    "killswitch.finance/ticker": Witnet.Sources.HttpGet({
        url: "https://api.killswitch.finance/ksw2/prices?chain=56",
        script: Witnet.Script().parseJSONMap().getFloat("\\0\\").multiply(1e6).round(),
    }),
    "korbit.co.kr/ticker": Witnet.Sources.HttpGet({
    ...
    "kraken.com/ticker": Witnet.Sources.HttpGet({
        url: "https://api.kraken.com/0/public/Ticker?pair=\\0\\\\1\\",
        script: Witnet.Script().parseJSONMap().getMap("result").values().getMap(0).getArray("a").getFloat(0).multiply(1e6).round(),
    }),
    "kraken.com/ticker#9": Witnet.Sources.HttpGet({
        url: "https://api.kraken.com/0/public/Ticker?pair=\\0\\\\1\\",
        script: Witnet.Script().parseJSONMap().getMap("result").values().getMap(0).getArray("a").getFloat(0).multiply(1e9).round(),
    }),
    "kucoin.com/ticker": Witnet.Sources.HttpGet({
    ...
    "kucoin.com/ticker#9": Witnet.Sources.HttpGet({
        url: "https://api.kucoin.com/api/v1/market/orderbook/level1?symbol=\\0\\-\\1\\",
        script: Witnet.Script().parseJSONMap().getMap("data").getFloat("price").multiply(1e9).round(),
    }),
    "live-rates.com/ticker-9": Witnet.Sources.HttpGet({
    ...
    "mastercard.us/ticker#9": Witnet.Sources.HttpGet({
        url: "https://www.mastercard.us/settlement/currencyrate/conversion-rate?fxDate=0000-00-00&transCurr=\\0\\&crdhldBillCurr=\\1\\&bankFee=0&transAmt=1",
        script: Witnet.Script().parseJSONMap().getMap("data").getFloat("conversionRate").multiply(1e9).round(),
    }),
    ...
    "mexc.com/ticker": Witnet.Sources.HttpGet({
    ...
    "revolut.com/ticker#9": Witnet.Sources.HttpGet({
        url: "https://www.revolut.com/api/exchange/quote?amount=1&country=\\2\\&fromCurrency=\\0\\&isRecipientAmount=false&toCurrency=\\1\\",
        headers: { "Accept-language": "en", }, 
        script: Witnet.Script().parseJSONMap().getMap("rate").getFloat("rate").multiply(1e9).round(),
    }),
    ...
    "ultron-dev.net/ticker#inverse": Witnet.Sources.HttpGet({
        url: "https://exchange-info.ultron-dev.net/api/v1/ultronswap",
    ...
    "upbit.com/ticker": Witnet.Sources.HttpGet({
    ...
    "xt.pub/ticker": Witnet.Sources.HttpGet({
