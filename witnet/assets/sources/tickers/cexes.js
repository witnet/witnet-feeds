...
module.exports = {
    ...
    "ticker/bkex.com": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getArray("data").getMap(0).getFloat("price").multiply(1e6).round(),
        // samples: {
        //     "op/usdt": [ "OP", "USDT" ],
        //     "reef/usdt": [ "REEF", "USDT" ],
        //     "sys/usdt": [ "SYS", "USDT" ],
    ...
    "ticker/binance.com": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getFloat("price").multiply(1e6).round(),
        samples: {
            "bnb/usdt":  ["BNB", "USDT"],
            "busd/usdt": ["BUSD", "USDT"],
            "cfx/usdt":  ["CFX", "USDT"],
    ...
    "ticker/bitfinex.com": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getFloat("last_price").multiply(1e6).round(),
        samples: {
            "btc/usd": ["btc", "usd"],
            "eos/usd": ["eos", "usd"],
            "eth/usd": ["eth", "usd"],
    ...
    "ticker/bitfinex.com_v2": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getFloat(0).multiply(1e6).round(),
    }),
    "ticker/bitget.com": retrievals.HttpGet({
        url: "https://api.bitget.com/api/spot/v1/market/ticker?symbol=\\0\\",
        script: RadonScript(RadonString).parseJSONMap().getMap("data").getFloat("close").multiply(1e6).round(),
        samples: { 
    ...
    "ticker/bitget.com_v2": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getArray("data").getMap(0).getFloat("lastPr").multiply(1e6).round(),
        samples: { 
            "kaia/usdt": [ "KAIA", "USDT", ], 
        },
    }),
    "ticker/bitmart.com": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getMap("data").getArray("tickers").getMap(0).getFloat("last_price").multiply(1e6).round(),
        samples :{
            "mnt/usdt": [ "MNT", "USDT" ],
            // "wit/usdt": [ "WIT", "USDT" ],
            // "wld/usdt": [ "WLD", "USDT" ],
    ...
    "ticker/bitstamp.net": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getFloat("last").multiply(1e6).round(),
        samples: {
            "ada/usd": [ "ada", "usd" ],
            "algo/usd": [ "algo", "usd" ],
            "avax/usd": [ "avax", "usd" ],
    ...
    "ticker/bittrex.com": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getFloat("lastTradeRate").multiply(1e6).round(),
        // samples: {
        //     "dot/usd": [ "DOT", "USD" ],
        // },
    }),
    ...
    "ticker/bybit.com": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getMap("result").getArray("list").getMap(0).getFloat("lastPrice").multiply(1e6).round(),
        samples: {
    ...
    "ticker/coinbase.com": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getMap("data").getMap("rates").getFloat("\\0\\").power(-1).multiply(1e6).round(),
        samples: {
            "ada/usd": [ "ADA", "USD" ],
            "algo/usd": [ "ALGO", "USD" ],
            "ape/usd": [ "APE", "USD" ],
    ...
    "ticker#9/coinbase.com": retrievals.HttpGet({
        url: "https://api.coinbase.com/v2/exchange-rates?currency=\\1\\",
        script: RadonScript(RadonString).parseJSONMap().getMap("data").getMap("rates").getFloat("\\0\\").power(-1).multiply(1e9).round(),
        samples: {
            "shib/usd": [ "SHIB", "USD" ],
        },
    }),
    "ticker/coinflex.com": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getArray("data").getMap(0).getFloat("markPrice").multiply(1e6).round(),
    }),
    "ticker/coinone.co.kr": retrievals.HttpGet({
        url: "https://api.coinone.co.kr/public/v2/ticker_new/\\0\\/\\1\\",
        script: RadonScript(RadonString).parseJSONMap().getArray("tickers").getMap(0).getFloat("last").multiply(1e3).round(),
        samples: {
            "krw/ksp": [ "krw", "ksp" ],
        },
    }),
    "ticker#9/coinyep.com": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getFloat("price").multiply(1e9).round(),
    }),
    "ticker/digifinex.com": retrievals.HttpGet({
        url: "https://openapi.digifinex.com/v3/ticker?symbol=\\0\\_\\1\\",
        script: RadonScript(RadonString).parseJSONMap().getArray("ticker").getMap(0).getFloat("last").multiply(1e6).round(),
        samples: {
            // "ftm/usdt": [ "ftm", "usdt" ],
            "op/usdt":  [ "op", "usdt" ],
            "reef/usdt": [ "reef", "usdt" ],
    ...
    "ticker#9/freeforexapi.com": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getMap("rates").getMap("\\0\\").getFloat("rate").power(-1).multiply(1e9).round(),
    }),
    ...
    "ticker#9/gateapi.io": retrievals.HttpGet({
        url: "https://data.gateapi.io/api2/1/ticker/\\0\\_\\1\\",
        script: RadonScript(RadonString).parseJSONMap().getFloat("last").multiply(1e9).round(),
    }),
    "ticker#9/exchangerate.host": retrievals.HttpGet({
        url: "https://api.exchangerate.host/latest?base=\\0\\&symbol=\\1\\",
        script: RadonScript(RadonString).parseJSONMap().getMap("rates").getFloat("\\1\\").multiply(1e9).round(),
        // samples: { 
        //     "krw/usd": [ "KRW", "USD" ] 
        // },
    }),
    "ticker#9/fastforex.io": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getMap("result").getFloat("\\1\\").multiply(1e9).round(),
        samples: { 
            "krw/usd": [ "KRW", "USD" ] 
        },
    }),
    ...
    "ticker/hitbtc.com": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getMap("\\0\\").getFloat("last").multiply(1e6).round(),
        samples: { 
            "reef/usdt": [ "REEFUSDT" ] 
        },
    }),
    "ticker/hotbit.io": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getFloat("result").multiply(1e6).round(),
        // samples: { 
        //     "glmr/usdt": [ "GLMR", "USDT" ],
        //     "metis/usdt": [ "METIS", "USDT" ],
        // },
    ...
    "ticker/huobi.pro": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getMap("tick").getFloat("close").multiply(1e6).round(),
        samples: {
            "bnb/usdt": [ "bnb", "usdt" ],
            "boba/usdt": [ "boba", "usdt" ],
            // "boring/usdt": [ "boring", "usdt" ],
    ...
    "ticker/indoex.io": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getArray("marketdetails").getMap(0).getFloat("last").multiply(1e6).round(),
        // samples: { 
        //     "busd/usdt": [ "BUSD", "USDT", ]
        // },
    }),
    "ticker#9/jsdelivr.net": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getMap("\\0\\").getFloat("\\1\\").multiply(1e9).round(),
    }),
    ...
    "ticker/korbit.co.kr": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getFloat("last").multiply(1e3).round(),
        // samples: {
        //     "ksp/krw": [ "ksp", "krw" ],
        // },
    }),
    "ticker/kraken.com": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getMap("result").values().getMap(0).getArray("a").getFloat(0).multiply(1e6).round(),
        samples: {
            "ada/usd": [ "ADA", "USD" ],
            "algo/usd": [ "ALGO", "USD" ],
            "ape/usd": [ "APE", "USD" ],
    ...
    "ticker#9/kraken.com": retrievals.HttpGet({
        url: "https://api.kraken.com/0/public/Ticker?pair=\\0\\\\1\\",
        script: RadonScript(RadonString).parseJSONMap().getMap("result").values().getMap(0).getArray("a").getFloat(0).multiply(1e9).round(),
    }),
    "ticker/kucoin.com": retrievals.HttpGet({
        url: "https://api.kucoin.com/api/v1/market/orderbook/level1?symbol=\\0\\-\\1\\",
        script: RadonScript(RadonString).parseJSONMap().getMap("data").getFloat("price").multiply(1e6).round(),
        samples: {
            "mtrg/ust": [ "MTRG", "USDT" ],
        },
    }),
    "ticker#9/kucoin.com": retrievals.HttpGet({
        url: "https://api.kucoin.com/api/v1/market/orderbook/level1?symbol=\\0\\-\\1\\",
        script: RadonScript(RadonString).parseJSONMap().getMap("data").getFloat("price").multiply(1e9).round(),
        samples: {
            "bnb/usdt": [ "BNB", "USDT" ],
            "cfx/usdt": [ "CFX", "USDT" ],
            "cro/usdt": [ "CRO", "USDT" ],
    ...
    "ticker#9/live-rates.com": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString)
            .parseJSONArray()
            .filter(
                RadonScript(RadonMap).getString("currency").match(
                    RadonBoolean,
                    { "\\1\\/\\0\\": true }, 
                    false
                )
    ...
    "ticker/mastercard.us": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getMap("data").getFloat("conversionRate").multiply(1e6).round(),
        // samples: {
        //     "hkd/usd": [ "HKD", "USD" ],
        //     "krw/usd": [ "KRW", "USD" ],
        // },
    ...
    "ticker#9/mastercard.us": retrievals.HttpGet({
        url: "https://www.mastercard.us/settlement/currencyrate/conversion-rate?fxDate=0000-00-00&transCurr=\\0\\&crdhldBillCurr=\\1\\&bankFee=0&transAmt=1",
        script: RadonScript(RadonString).parseJSONMap().getMap("data").getFloat("conversionRate").multiply(1e9).round(),
    }),
    "ticker#9/messari.io": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getMap("data").getMap("market_data").getFloat("price_\\1\\").multiply(1e9).round(),
    ...
    "ticker#9/mexc.com": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getArray("data").getMap(0).getFloat("last").multiply(1e9).round(),
    }),
    ...
    "ticker/okx.com": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getArray("data").getMap(0).getFloat("last").multiply(1e6).round(),
    }),
    ...
    "ticker/revolut.com": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getMap("rate").getFloat("rate").multiply(1e6).round(),
        samples: {
            "hkd/usd": [ "HKD", "USD", "US" ],
            "krw/usd": [ "KRW", "USD", "KR" ],
        },
    ...
    "ticker#9/revolut.com": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getMap("rate").getFloat("rate").multiply(1e9).round(),
    }),
    "ticker/ultron-dev.net": retrievals.HttpGet({
        url: "https://exchange-info.ultron-dev.net/api/v1/ultronswap",
        script: RadonScript(RadonString).parseJSONMap().getMap("\\1\\_\\0\\").getFloat("last_price").multiply(1e6).round(),
        samples: { 
    ...
    "ticker/ultron-dev.net#inverse": retrievals.HttpGet({
        url: "https://exchange-info.ultron-dev.net/api/v1/ultronswap",
        script: RadonScript(RadonString).parseJSONMap().getMap("\\0\\_\\1\\").getFloat("last_price").power(-1).multiply(1e6).round(),
        samples: { 
    ...
    "ticker/upbit.com": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONArray().getMap(0).getFloat("trade_price").multiply(1e6).round(),
        samples: {
            "bat/usdt": [ "BAT", "USDT" ],
        },
    }),
    "ticker/xt.pub": retrievals.HttpGet({
        ...
        script: RadonScript(RadonString).parseJSONMap().getMap("\\0\\_\\1\\").getFloat("last").multiply(1e6).round(),
    }),
}
