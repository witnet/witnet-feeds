...
module.exports = {
    ...
    WitOracleRequestTemplateBeamswapTicker6: Witnet.PriceTickerTemplate({
        retrieve: sources['beamswap/ticker'],
        tests: { 
            "GLINT/USDC-6 must work": [[ "0x61b4cec9925b1397b64dece8f898047eed0f7a07", "0" ]],
        },
    }),

    WitOracleRequestTemplateKuswapTicker6: Witnet.PriceTickerTemplate({
        retrieve: sources['kuswap/ticker'],
        tests: { 
            "KUS/KCS-6 must work": [[ "0x1ee6b0f7302b3c48c5fa89cd0a066309d9ac3584", "0" ]],
        },
    }),

    WitOracleRequestTemplateMojitoTicker6: Witnet.PriceTickerTemplate({
        retrieve: sources['mojitoswap/ticker'],
        tests: { 
    ...
    WitOracleRequestTemplateMojitoTicker9: Witnet.PriceTickerTemplate({
        retrieve: sources['mojitoswap/ticker#9'],
        tests: { 
    ...
    WitOracleRequestTemplateOolongTicker6: Witnet.PriceTickerTemplate({
        retrieve: sources['oolongswap/ticker'],
        tests: { 
    ...
    WitOracleRequestTemplatePancakeBscExchangeTicker6: Witnet.PriceTickerTemplate({
    ...
    WitOracleRequestTemplateQuickswapTicker6: Witnet.PriceTickerTemplate({
    ...
    WitOracleRequestTemplateQuickswapTicker9: Witnet.PriceTickerTemplate({
        retrieve: sources['quickswap-v3/ticker#9'],
        tests: { 
            "QUICK/USDC-9 must work": [[ "0x022df0b3341b3a0157eea97dd024a93f7496d631", "0" ]],
        },
    }),

    WitOracleRequestTemplateStellaswapTicker6: Witnet.PriceTickerTemplate({
        retrieve: sources['stellaswap/ticker'],
        tests: { 
            "STELLA/USDT-6 must work": [[ "0x81e11a9374033d11cc7e7485a7192ae37d0795d6", "1" ]],
        },
    }),
    WitOracleRequestTemplateSushiswapTicker6: Witnet.PriceTickerTemplate({
        retrieve: sources['sushiswap/ticker'],
        tests: { 
            "VSQ/DAI-6 must work": [[ "0x5cf66ceaf7f6395642cd11b5929499229edef531", "1" ]],
        },
    }),

    WitOracleRequestTemplateUbeswapTicker6: Witnet.PriceTickerTemplate({
        retrieve: sources['ubeswap/ticker'],
        tests: { 
            "IMMO/mCUSD-6 must work": [[ "0x7d63809ebf83ef54c7ce8ded3591d4e8fc2102ee", "0" ]],
        },
    }),

    WitOracleRequestTemplateUniswapCeloTicker6: Witnet.PriceTickerTemplate({
        retrieve: sources['uniswap-celo/ticker'],
        tests: { 
            "NCT/CELO-6 must work": [[ "0xdb24905b1b080f65dedb0ad978aad5c76363d3c6", "1" ]],
        },
    }),

    WitOracleRequestTemplateUniswapV3Ticker6: Witnet.PriceTickerTemplate({
        retrieve: sources['uniswap-v3/ticker'],
        tests: { 
